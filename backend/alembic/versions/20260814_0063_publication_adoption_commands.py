...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("actor_user_id", sa.String(512), nullable=False),
        sa.Column("idempotency_key", sa.String(128), nullable=False),
        sa.Column("request_checksum", sa.String(128), nullable=False),
        sa.Column("release_id", sa.String(512), nullable=False),
        sa.Column("resource_type", sa.String(64), nullable=False),
        sa.Column("target_agent_id", sa.String(512), nullable=True),
        sa.Column("binding_id", sa.String(512), nullable=True),
        sa.Column("adopted_agent_id", sa.String(512), nullable=True),
