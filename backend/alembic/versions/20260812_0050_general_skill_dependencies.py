...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("parent_skill_id", sa.String(128), nullable=False),
        sa.Column("parent_revision_id", sa.String(128), nullable=False),
        sa.Column("child_skill_id", sa.String(128), nullable=False),
        sa.Column("child_revision_id", sa.String(128), nullable=False),
