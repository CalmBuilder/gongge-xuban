...
import IconCotAdvance from '@/assets/product/cot-icons/advance.svg?react';
import IconCotExecute from '@/assets/product/cot-icons/execute.svg?react';
import IconCotGenerated from '@/assets/product/cot-icons/generated.svg?react';
import IconCotJudge from '@/assets/product/cot-icons/judge.svg?react';
import IconCotLoading from '@/assets/product/cot-icons/loading.svg?react';
import IconCotSelect from '@/assets/product/cot-icons/select.svg?react';
import IconCotTool from '@/assets/product/cot-icons/tool.svg?react';
