...
const iconPaths: Record<ProductIconName, string[]> = {
  arrow: ['M9 5l6 7-6 7'],
...
export default function ProductIcon({ name, className = '', size = 18, style }: ProductIconProps) {
  return (
    <svg
      className={`product-icon product-icon-${name} ${className}`.trim()}
      width={size}
      height={size}
      viewBox="0 0 24 24"
      aria-hidden="true"
