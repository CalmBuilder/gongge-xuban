  ...
  return (
    <div className="min-h-full w-full min-w-0 max-w-full box-border px-[48px] pt-[32px] pb-[43px] max-[900px]:px-[16px]">
      <div className="mx-auto flex min-h-[calc(100vh-220px)] max-w-[560px] flex-col items-center justify-center text-center">
        ...
        <h2 className="mt-[24px] gg-type-section-title font-semibold  text-[var(--gg-ink)]">
          还没有数字员工
        </h2>
        <p className="mt-[10px] gg-type-body  text-[var(--gg-slate)]">
          {isAdmin
        ...
        <div className="mt-[28px] flex flex-wrap items-center justify-center gap-[12px]">
          <UiButton
            onClick={onCreate}
            className="inline-flex h-[42px] items-center gap-[8px] rounded-[var(--gg-radius-control)] bg-[var(--gg-cobalt)] px-[22px] gg-type-body font-semibold text-white shadow-[0_8px_20px_rgba(49,87,232,0.22)] hover:bg-[#244bc7]"
          >
          ...
          <UiButton
            ...
            className="inline-flex h-[42px] items-center gap-[8px] rounded-[var(--gg-radius-control)] border border-[var(--gg-border)] bg-[var(--gg-paper)] px-[22px] gg-type-body font-medium text-[var(--gg-slate)] hover:border-[#bfcbea] hover:bg-[var(--gg-cloud)] hover:text-[var(--gg-cobalt)]"
          >
