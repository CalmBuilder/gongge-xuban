      ...
      >
        ...
        <div className="flex shrink-0 justify-end gap-[10px]">
          ...
          <button
            type="button"
            onClick={onCopy}
            className="inline-flex h-[34px] items-center justify-center rounded-[var(--gg-radius-control)] border border-[#d7deed] bg-white px-[14px] text-[12px] font-semibold text-[#52617d] transition-colors hover:border-[var(--gg-cobalt)] hover:text-[var(--gg-cobalt)]"
          >
            复制并定制
          </button>
          <button
            type="button"
            onClick={onUse}
            className="inline-flex h-[34px] items-center justify-center rounded-[var(--gg-radius-control)] bg-[var(--gg-cobalt)] px-[14px] text-[12px] font-semibold text-white transition-colors hover:bg-[#244bc7]"
          >
            添加使用并开始对话
          </button>
        </div>
