...
/**
 * `dot`  – short centered rounded indicator under the active label (共格 node 38:6404).
 * `line` – full-tab-width 2px active bar over a full-width bottom divider (共格 node 281:1935).
 */
      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={cn(
              'relative flex w-[120px] items-start justify-center px-[16px] gg-type-control capitalize transition-colors outline-none',
