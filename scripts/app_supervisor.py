...
ENTERPRISE_HOST = SETTINGS.enterprise_host
ENTERPRISE_PORT = str(SETTINGS.enterprise_port)
AUTO_RESTART = SETTINGS.auto_restart
STARTUP_GRACE_SECONDS = SETTINGS.dev_startup_timeout

api_host = "127.0.0.1" if BACKEND_HOST == "0.0.0.0" else BACKEND_HOST
API_BASE_URL = SETTINGS.vite_api_base_url or SETTINGS.api_base_url or (
    "" if SINGLE_PORT else f"http://{api_host}:{BACKEND_PORT}"
)
